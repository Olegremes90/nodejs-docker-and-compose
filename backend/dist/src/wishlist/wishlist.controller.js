...
let WishlistController = class WishlistController {
    ...
    async getWishesById(req, id) {
        return this.wishlistService.getWishlistById(id);
    }
    async createWishlist(creatWishlistDto) {
        return this.wishlistService.createWishlist(creatWishlistDto);
    }
    async updateWishlist(req, id, creatWishlistDto) {
        await this.wishlistService.checkAccessUpdateOrDeleteResource(req.user.id, id);
        return this.wishlistService.updateWishlist(id, creatWishlistDto);
    }
    async deleteWishlist(req, id) {
        await this.wishlistService.checkAccessUpdateOrDeleteResource(req.user.id, id);
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], WishlistController.prototype, "getWishesById", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [wishlist_dto_1.CreateWishlistDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, wishlist_dto_1.CreateWishlistDto]),
    __metadata("design:returntype", Promise)
